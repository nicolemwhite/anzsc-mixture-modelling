...
#To set up missing data in BUGS, need to assign at least one observation to each cluster as initial values. 
#This can be a bit awkward for larger values of K and/or multiple dimensions
...
## Note that the DIC calculated from BUGS has not been adapted for use in mixture models. 
## For alternative formulations, see Celeux et al 2006, Bayesian Analysis 1, Number 4, pp. 651-674
